...
async function updateController(req, res) {
    ...
    if (req.file) {
        ...
        const updatedCurse = await _3_Section_1.default.findByIdAndUpdate(id, { title, description, task, test, time, timeex, conceptual, procedimental, actitudinal, img: req.file.path });
    }
    else {
        const updatedCurse = await _3_Section_1.default.findByIdAndUpdate(id, { title, description, task, test, time, timeex, conceptual, procedimental, actitudinal });
    }
    return res.json({
