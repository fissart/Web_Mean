...
export class NavigationComponent implements OnInit {
   ...
   constructor(public authService: AuthService, public curseService: CurseService, public userService: UsersService, private iconRegistry: MatIconRegistry, private sanitizer: DomSanitizer) {
      iconRegistry.addSvgIconLiteral('www', sanitizer.bypassSecurityTrustHtml(`
  <svg
   width="93.745262mm"
   height="69.319557mm"
